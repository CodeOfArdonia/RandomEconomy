...
public final class NeeScreenHandlers {
    ...
    public static final ScreenHandlerType<SystemStationOwnerScreenHandler> SYSTEM_STATION_OWNER = register("system_station_owner", new ScreenHandlerType<>(SystemStationOwnerScreenHandler::new, FeatureSet.of(FeatureFlags.VANILLA)));
    public static final ScreenHandlerType<SystemStationCustomerScreenHandler> SYSTEM_STATION_CUSTOMER = register("system_station_customer", new ScreenHandlerType<>(SystemStationCustomerScreenHandler::new, FeatureSet.of(FeatureFlags.VANILLA)));
