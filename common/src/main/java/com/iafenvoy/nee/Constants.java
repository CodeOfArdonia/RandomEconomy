...
public class Constants {
    ...
    public static final Identifier SYSTEM_TRADE = Identifier.of(NotEnoughEconomy.MOD_ID, "trade_system");
    public static final Identifier TRADE_STATE_CHANGE = Identifier.of(NotEnoughEconomy.MOD_ID, "trade_state_change");
}
