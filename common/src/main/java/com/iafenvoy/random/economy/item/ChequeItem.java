...
public class ChequeItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        if (value > 0) tooltip.add(Text.translatable("item.random_economy.value", value));
        if (owner != null) tooltip.add(Text.translatable("item.random_economy.owner", owner));
    }
    ...
    public static ItemStack create(int value, String owner) {
        ItemStack stack = new ItemStack(NeeItems.CHEQUE.get());
