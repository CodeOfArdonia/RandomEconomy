...
import com.iafenvoy.random.economy.util.InventoryUtil;
...
public final class PlayerExchangeHolder {
    ...
    public void onCancel(Text canceller) {
        ...
        this.user1.player.sendMessage(Text.translatable("command.random_economy.trade_cancel", canceller));
        this.user2.player.sendMessage(Text.translatable("command.random_economy.trade_cancel", canceller));
        this.close();
    }
    ...
    public void onConfirm() {
        ...
        this.user1.player.sendMessage(Text.translatable("command.random_economy.trade_success"));
        this.user2.player.sendMessage(Text.translatable("command.random_economy.trade_success"));
        this.close();
    }
    ...
    private NamedScreenHandlerFactory createScreen(Single current, Single another) {
        ...
        return new ExtendedMenuProvider() {
            ...
            public Text getDisplayName() {
                return Text.translatable("screen.random_economy.trade");
            }
